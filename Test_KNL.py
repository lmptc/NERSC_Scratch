...
InfoDict['Bands'] = ['g', 'i']
InfoDict['dT1s'] = np.arange(0, 121, 15)
InfoDict['dT2s'] =  np.arange(0, 121, 30)[1:]
...
MMMDD = timestring[4:7]+timestring[8:10]
MMMDD = MMMDD.replace(' ', '0')
HHMM = timestring[11:16]

FileName = '_'.join(['ProbabilityCube', MMMDD, HHMM, '_',
