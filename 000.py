...
StartEvent, EndEvent, StartObj = int(a), int(b), int(c)
...
EventNames = EventNames[StartEvent: EndEvent]

PointsPerDay = 1
Objects = np.arange(StartObj, 40000, 16)
